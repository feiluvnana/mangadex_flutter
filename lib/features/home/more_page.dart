  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(padding: EdgeInsets.zero, children: [
      ...
      ListTile(
          ...
          trailing: Switch(
              value: settingsState.downloadedOnly, onChanged: settingsNotifier.setDownloadedOnly)),
      ListTile(
          leading: const Icon(Icons.history_toggle_off),
          title: const Text("Incognito mode"),
          subtitle: const Text("Pause reading history"),
          trailing: Switch(
              value: settingsState.incognitoMode, onChanged: settingsNotifier.setIncognitoMode)),
      const Divider(),
      ...
      const ListTile(
          leading: Icon(Icons.settings_backup_restore), title: Text("Backup and restore")),
      const Divider(),
      ListTile(
